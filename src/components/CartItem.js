...
export const CartItem = ({ product }) => {
    ...
    return (
        <div className="flex flex-col w-full my-2  items-center justify-between p-2 bg-white border border-gray-200 rounded-lg shadow md:flex-row    dark:border-gray-700 dark:bg-gray-800 ">
           ...
           <div> <span onClick={()=>removeFromCart(product)} className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-blue-800">Remove</span></div>
        </div>
    )
}
